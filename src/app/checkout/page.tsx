            ...
            <div className="max-w-md mt-16  md:mt-10 md:p-6">
              ...
              <form>
                ...
                <div className="flex justify-center mt-8">
                  <button
                    type="submit"
                    className=" text-[14px] md:text-[16px] py-2 md:py-3 px-14 md:px-20  border border-black rounded-[12px] text-black text-center hover:bg-[#B88E2F] hover:text-white duration-200"
                  >
                    Place order
                  </button>
                </div>
